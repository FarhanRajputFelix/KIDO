...
class _SplashRouterState extends State<_SplashRouter> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkAuth() async {
    ...
    if (auth.status == AuthStatus.authenticated) {
      if (auth.isChild) Navigator.pushReplacementNamed(context, '/home/child');
      else if (auth.isParent) Navigator.pushReplacementNamed(context, '/home/parent');
      else if (auth.isTeacher) Navigator.pushReplacementNamed(context, '/home/teacher');
            ...
            child: ScaleTransition(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('KIDO', style: TextStyle(fontSize: 48, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: 6)),
                  const SizedBox(height: 8),
                  const Text('Safe. Smart. Fun.', style: TextStyle(color: Colors.white70, fontSize: 16, letterSpacing: 2)),
