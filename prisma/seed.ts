...
async function main() {
    ...
    prisma.quiz.create({
      data: {
        ...
        questions: JSON.stringify([
          { question: "Which planet is closest to the Sun?", options: ["Venus", "Mercury", "Earth", "Mars"], correctAnswer: 1 },
          { question: "What is the largest planet in our solar system?", options: ["Saturn", "Neptune", "Jupiter", "Uranus"], correctAnswer: 2 },
          { question: "How many planets are in our solar system?", options: ["7", "8", "9", "10"], correctAnswer: 1 },
          { question: "Which planet is known as the Red Planet?", options: ["Venus", "Jupiter", "Mars", "Saturn"], correctAnswer: 2 },
          { question: "What is the hottest planet?", options: ["Mercury", "Venus", "Mars", "Jupiter"], correctAnswer: 1 },
        ]),
      },
    }),
    prisma.quiz.create({
      data: {
        title: "Math Multiplication Challenge",
        subject: "math",
        difficulty: "easy",
        xpReward: 40,
        timeLimit: 90,
        ...
        ageMax: 10,
        questions: JSON.stringify([
          { question: "What is 6 × 7?", options: ["36", "42", "48", "54"], correctAnswer: 1 },
          { question: "What is 8 × 9?", options: ["63", "72", "81", "64"], correctAnswer: 1 },
          { question: "What is 12 × 5?", options: ["55", "60", "65", "50"], correctAnswer: 1 },
          { question: "What is 9 × 9?", options: ["72", "81", "90", "99"], correctAnswer: 1 },
          { question: "What is 7 × 8?", options: ["54", "56", "58", "52"], correctAnswer: 1 },
        ]),
      },
    }),
    prisma.quiz.create({
      data: {
        ...
        ageMax: 14,
        questions: JSON.stringify([
          { question: "What is the longest river in the world?", options: ["Amazon", "Nile", "Mississippi", "Yangtze"], correctAnswer: 1 },
          { question: "Which continent is the largest?", options: ["Africa", "North America", "Asia", "Europe"], correctAnswer: 2 },
          ...
          { question: "What country has the most people?", options: ["India", "USA", "China", "Indonesia"], correctAnswer: 0 },
        ]),
      },
    }),
    prisma.quiz.create({
      data: {
        ...
        questions: JSON.stringify([
          ...
          { question: 'Which sentence is correct?', options: ["She don't like it", "She doesn't like it", "She doesn't likes it", "She don't likes it"], correctAnswer: 1 },
          { question: "What is a verb?", options: ["A person", "An action word", "A describing word", "A place"], correctAnswer: 1 },
          { question: 'Choose the correct spelling:', options: ["Beautifull", "Beatiful", "Beautiful", "Beutiful"], correctAnswer: 2 },
        ]),
      },
    }),
    prisma.quiz.create({
      data: {
        ...
        ageMax: 14,
        questions: JSON.stringify([
          { question: "What does 'print()' do in Python?", options: ["Reads input", "Displays output", "Creates variables", "Deletes files"], correctAnswer: 1 },
          { question: "Which is a valid variable name?", options: ["1name", "my-var", "my_var", "class"], correctAnswer: 2 },
          { question: "What does 'len()' return?", options: ["The type", "The length", "The sum", "The max"], correctAnswer: 1 },
          { question: "What is a loop?", options: ["A type of variable", "Code that repeats", "A function", "An error"], correctAnswer: 1 },
          { question: "What symbol is used for comments?", options: ["//", "/*", "#", "--"], correctAnswer: 2 },
        ]),
      },
    }),
    prisma.quiz.create({
      data: {
        ...
        ageMax: 14,
        questions: JSON.stringify([
          { question: "Where were the pyramids built?", options: ["Rome", "Greece", "Egypt", "China"], correctAnswer: 2 },
          { question: "Who was the first Roman Emperor?", options: ["Julius Caesar", "Augustus", "Nero", "Caligula"], correctAnswer: 1 },
          { question: "What civilization built Machu Picchu?", options: ["Aztec", "Maya", "Inca", "Olmec"], correctAnswer: 2 },
          { question: "The Great Wall was built by which civilization?", options: ["Japanese", "Korean", "Chinese", "Mongolian"], correctAnswer: 2 },
          { question: "What is the ancient writing of Egypt called?", options: ["Cuneiform", "Hieroglyphics", "Sanskrit", "Runes"], correctAnswer: 1 },
        ]),
      },
    }),
  ]);
  ...
  // Create quiz attempts for children
  const attempts = [
  ...
  for (const a of attempts) {
    await prisma.quizAttempt.create({
      data: {
        ...a,
        answers: JSON.stringify([1, 2, 1, 2, 1]),
  ...
  console.log("✅ Activity feed, alerts, badges, and classrooms created");
  console.log("\n🎉 Seeding complete!");
  console.log("\n📧 Login credentials:");
